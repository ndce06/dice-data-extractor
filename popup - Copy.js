document.addEventListener('DOMContentLoaded', function() {
    ...
    aDownload.addEventListener('click', function() {
        ...
        if(captureData) {
            var colDelim = '","',
                rowDelim = '"\r\n"', 
                csv = 'JOB TITLE","LOCATION","POSTED_TIME","COMPANY","DESCRIPTION","JOB_HTML_LINK","COMPANY_LINK","JOB_TYPE","MATCH","POINT';
            ...
            if(response && response.dom) {
              ...
              if(searchContent && searchContent.length > 0) {
                ...
                $rows.each(function(i){
                    ...
                    var job_title = '=HYPERLINK("'+ job_link +'", "' + $row.find('h3').find('a.dice-btn-link')[0].attr('title') + '")';
